...
<html>
  ...
  <body onload="disptime()">
	<form  method="post" name="myform" action="/FDoctorWeb/info/diagnose" onsubmit="return pre()">
		<div align="center">
		<table width="400" border="0" class="table">
			<tbody>
				...
				<tr>
					...
					<td width="100">&nbsp;&nbsp;本诊断结果仅做参考</td>
				</tr>
				<tr>
				<td>&nbsp;</td>
				<td>&nbsp;<input type="Submit" value="诊断" /> </td>
				</tr>
			</tbody>
		</table>
			<div style="color:red;"> 
